  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin/customers/:customerId/devices/:deviceId" element={<ProtectedRoute routeName="admin-device-detail" requireRole="admin" element={<AdminLayout onLogout={handleLogout}><AdminDeviceDetail /></AdminLayout>} />} />
